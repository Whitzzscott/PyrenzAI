...
export default function RequiredFieldsPopup({ missingFields, onClose }: RequiredFieldsPopupProps) {
  return (
    <div
    ...
    >
      <div
        ...
        role="alertdialog"
      >
        <h2 id="missingFieldsTitle" className="text-xl font-bold mb-6 text-center">
          Missing Required Fields
        </h2>
        <ul id="missingFieldsList" className="list-disc list-inside mb-6 flex-grow space-y-3">
